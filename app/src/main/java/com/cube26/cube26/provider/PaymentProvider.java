...
public class PaymentProvider extends ContentProvider {
    ...
    public static final String PROVIDER_NAME = "com.cube26.cube26.provider";
    public static final String URL = "content://" + PROVIDER_NAME + "/payment";
    public static final Uri CONTENT_URI = Uri.parse(URL);

    //Integer value used in content uri
    static final int PAYMENT = 1;
    static final int PAYMENT_ID = 2;

    private static HashMap<String,String> MovieMap;

    public PaymentSQLiteHelper sqLiteOpenHelper;
    private SQLiteDatabase database;

    static final UriMatcher uriMatcher;
    static {
        uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        uriMatcher.addURI(PROVIDER_NAME, "/*", PAYMENT_ID);
    }

    @Override
    public boolean onCreate() {
        Context context = getContext();
        sqLiteOpenHelper = new PaymentSQLiteHelper(context);
